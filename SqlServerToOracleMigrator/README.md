...
| SQL Server 테이블명 | Oracle 테이블명 | 활성화 | 설명 |
|-------------------|----------------|-------|------|
| dbo.Employees | EMPLOYEES | TRUE | 직원 정보 |
| dbo.Departments | DEPARTMENTS | TRUE | 부서 정보 |
| dbo.Projects | PROJECTS | FALSE | 현재 제외 |
...
프로그램을 실행하면 **활성화된 테이블만** 마이그레이션이 수행됩니다.
